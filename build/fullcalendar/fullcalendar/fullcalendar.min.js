...
r.eventDrop,ma=r.getDaySegmentContainer,wa=r.getHoverListener,za=r.renderDayOverlay,pa=r.clearOverlays,na=r.getRowCnt,qa=r.getColCnt,Aa=r.renderDaySegs,sa=r.resizableDayEvent}function wc(a,b){function l(k,s){if(s){ha(k,s);m("weekends")||Sa(k,s<0?-1:1)}s=J(k,true);var G=ha(J(s),1);e.title=A(k,m("titleFormat"));e.start=e.visStart=s;e.end=e.visEnd=G;r()}var e=this;e.render=l;xc.call(e,a,b,"resourceView");var m=e.opt,r=e.renderResource,A=b.formatDate}function xc(a,b,l){function e(){Ha=R.length;m();i?
da():r();A()}function m(){$a=I("theme")?"ui":"fc";yb=I("weekends")?0:1;zb=I("firstDay");if(Qa=I("isRTL")){Ka=-1;Na=Ha-1}else{Ka=1;Na=0}La=lb(I("minTime"));eb=lb(I("maxTime"));u=I("columnFormat")}function r(){var c=$a+"-widget-header",j=$a+"-widget-content",w,M,ja,ya,Da,Ea=I("slotMinutes")%15==0;w="<table style='width:100%' class='fc-agenda-days fc-border-separate' cellspacing='0'><thead><tr><th class='fc-agenda-axis "+c+"'>&nbsp;</th>";for(M=0;M<Ha;M++)w+="<th class='fc- fc-col"+M+" "+c+"'/>";w+=
...
lazyFetching:true,startParam:"start",endParam:"end",titleFormat:{month:"MMMM yyyy",week:"MMM d[ yyyy]{ '&#8212;'[ MMM] d yyyy}",day:"dddd, MMM d, yyyy",resource:"dddd, MMM d, yyyy"},columnFormat:{month:"ddd",week:"ddd M/d",day:"dddd M/d"},timeFormat:{"":"h(:mm)t"},isRTL:false,firstDay:0,monthNames:["January","February","March","April","May","June","July","August","September","October","November","December"],monthNamesShort:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],
dayNames:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],dayNamesShort:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],buttonText:{prev:"&nbsp;&#9668;&nbsp;",next:"&nbsp;&#9658;&nbsp;",prevYear:"&nbsp;&lt;&lt;&nbsp;",nextYear:"&nbsp;&gt;&gt;&nbsp;",today:"today",month:"month",week:"week",day:"day",resourceDay:"resource"},theme:false,buttonIcons:{prev:"circle-triangle-w",next:"circle-triangle-e"},unselectAuto:true,dropAccept:"*"},Ec={header:{left:"next,prev today",center:"",right:"title"},
buttonText:{prev:"&nbsp;&#9658;&nbsp;",next:"&nbsp;&#9668;&nbsp;",prevYear:"&nbsp;&gt;&gt;&nbsp;",nextYear:"&nbsp;&lt;&lt;&nbsp;"},buttonIcons:{prev:"circle-triangle-e",next:"circle-triangle-w"}},Ga=t.fullCalendar={version:"1.5.4"},Xa=Ga.views={};t.fn.fullCalendar=function(a){if(typeof a=="string"){var b=Array.prototype.slice.call(arguments,1),l;this.each(function(){var m=t.data(this,"fullCalendar");if(m&&t.isFunction(m[a])){m=m[a].apply(m,b);if(l===ra)l=m;a=="destroy"&&t.removeData(this,"fullCalendar")}});
if(l!==ra)return l;return this}var e=a.eventSources||[];delete a.eventSources;if(a.events){e.push(a.events);delete a.events}a=t.extend(true,{},pb,a.isRTL||a.isRTL===ra&&pb.isRTL?Ec:{},a);this.each(function(m,r){m=t(r);r=new cc(m,a,e);m.data("fullCalendar",r);r.render()});return this};Ga.sourceNormalizers=[];Ga.sourceFetchers=[];var gc={dataType:"json",cache:false},hc=1;Ga.addDays=ha;Ga.cloneDate=J;Ga.parseDate=Gb;Ga.parseISO8601=Wb;Ga.parseTime=lb;Ga.formatDate=fb;Ga.formatDates=Eb;var rc=["sun",
"mon","tue","wed","thu","fri","sat"],Vb=864E5,ic=36E5,ac=6E4,jc={s:function(a){return a.getSeconds()},ss:function(a){return gb(a.getSeconds())},m:function(a){return a.getMinutes()},mm:function(a){return gb(a.getMinutes())},h:function(a){return a.getHours()%12||12},hh:function(a){return gb(a.getHours()%12||12)},H:function(a){return a.getHours()},HH:function(a){return gb(a.getHours())},d:function(a){return a.getDate()},dd:function(a){return gb(a.getDate())},ddd:function(a,b){return b.dayNamesShort[a.getDay()]},
...
12?"AM":"PM"},u:function(a){return fb(a,"yyyy-MM-dd'T'HH:mm:ss'Z'")},S:function(a){a=a.getDate();if(a>10&&a<20)return"th";return["st","nd","rd"][a%10-1]||"th"}};Ga.applyAll=rb;Xa.month=sc;Xa.basicWeek=tc;Xa.basicDay=uc;Bb({weekMode:"fixed"});Xa.resourceDay=wc;Bb({allDaySlot:true,allDayText:"all-day",firstHour:6,slotMinutes:30,defaultEventMinutes:120,axisFormat:"h(:mm)tt",timeFormat:{agenda:"h:mm{ - h:mm}"},dragOpacity:{agenda:0.5},minTime:0,maxTime:24});Xa.agendaWeek=Ac;Xa.agendaDay=Bc;Bb({allDaySlot:true,
